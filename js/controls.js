...
function check_button(btn) {
  return btn.css('filter') == "brightness(0.8)";
}

var Control_Buttons = {
  enabled: function() { return true; },
  up:    function() { return check_button( $('#up-arrow')    ); },
  down:  function() { return check_button( $('#down-arrow')  ); },
  left:  function() { return check_button( $('#left-arrow')  ); },
  right: function() { return check_button( $('#right-arrow') ); }
};
